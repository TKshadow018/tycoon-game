  ...
  return (
    <div className="pc-modal-overlay" onClick={(event) => event.stopPropagation()}>
      <div className="pc-modal" onClick={(event) => event.stopPropagation()}>
        ...
        <p className="pc-muted">Showing {filteredAvailableModels.length} of {availableModels.length} available models.</p>
        <div className="pc-model-grid">
          ...
          {filteredAvailableModels.map((model) => {
            ...
            return (
              <div key={model.id} className="pc-model-card">
                ...
                <button disabled={!canHire} onClick={() => onHire(model.id, model.name)}>Hire</button>
              </div>
            )
          })}
        </div>
