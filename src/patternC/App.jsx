      ...
      <main className="b-start-root">
        <section className="b-start-shell">
          <aside className="b-start-left">
            <p className="b-start-kicker">Pattern C</p>
            <h1>Agency Command Board</h1>
            <p>
              Run a high-pressure modeling agency where every day is a strategic decision.
              Sign talent, secure contracts, scale production, and outmaneuver rivals.
            </p>
